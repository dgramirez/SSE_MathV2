...
TEST_CASE("Equality Checks", "[IsZero], [IsEqual], [operator==] [operator!=]") {
	...
	SECTION("IsEqual Equality Check", "[IsEqual], [operator==]") {
		...
		CHECK(IsEqual(NotZeroV2, ImNotZero));

		//Static Check: Vector vs Float Pointer
		CHECK(IsEqual(NotZeroV2, fp));
		CHECK(IsEqual(fp, NotZeroV2));

		//Static Check: Vector vs m128
		CHECK(IsEqual(NotZeroV2, m128));
		CHECK(IsEqual(m128, NotZeroV2));

		//Static Check: Float Pointer vs Float Pointer
		CHECK(IsEqual(fp, fp));

		//Static Check: m128 vs m128
		CHECK(IsEqual(m128, m128));

		//Static Check: Float Pointer vs m128
		CHECK(IsEqual(fp, m128));
		CHECK(IsEqual(m128, fp));
		...
		CHECK_FALSE(IsEqual(randVecA, randVecB));
		CHECK_FALSE(IsEqual(randVecA, fp));
		CHECK_FALSE(IsEqual(fp, randVecB));
		CHECK_FALSE(IsEqual(randVecA, m128));
		CHECK_FALSE(IsEqual(m128, randVecB));
		CHECK_FALSE(IsEqual(randFPA, randFPB));
		CHECK_FALSE(IsEqual(randM128A, randM128B));
		CHECK_FALSE(IsEqual(randFPA, randM128B));
		CHECK_FALSE(IsEqual(randM128A, randFPB));
...
TEST_CASE("Basic Vector Math", "[Add], [Sub], [Mul], [Div]") {
	...
	SECTION("Addition", "[Add], [operator+], [operator+=]") {
		...
		answer[0]  = Set( 55457.96164f, 142416.94849f,  69813.91124f,  87456.52660f);
		answer[1]  = Set( 59983.88310f, 206507.27822f, 109854.26467f,  87576.12303f);
		answer[2]  = Set(156150.07383f, 281043.90000f, 142457.57959f, 118755.51654f);
		answer[3]  = Set(175552.92543f, 376006.00349f, 142774.17815f, 205587.84544f);
		answer[4]  = Set(268610.98788f, 447921.34789f, 144796.05915f, 252356.37492f);
		answer[5]  = Set(270183.66426f, 471313.98307f, 242454.77507f, 331910.23373f);
		answer[6]  = Set( 55457.96164f, 142416.94849f,  69813.91124f,  87456.52660f);
		answer[7]  = Set(112460.91405f, 166877.44789f,   2338.47956f, 133600.85838f);
		answer[8]  = Set( 40581.03150f, 111545.17473f, 109537.66611f,    743.79413f);
		answer[9]  = Set(115569.04233f, 169498.72527f,  32919.91348f, 118011.72241f);
		answer[10] = Set( 37627.78642f,  70847.48018f, 167156.02860f,  80178.05651f);
		answer[11] = Set( 97583.98391f, 136005.67413f,  42062.23443f,  46888.12591f);
		answer[12] = Set( 97738.86711f,  97929.25696f, 130262.03084f, 110733.25232f);
		answer[13] = Set(100692.11219f, 138626.95151f, 72643.668350f, 31298.989940f);
		answer[14] = Set( 94630.73883f,  95307.97958f,  99680.59692f, 126322.38829f);
		answer[15] = Set( 55457.96164f, 142416.94849f,  69813.91124f,  87456.52660f);
		answer[16] = Set(112460.91405f, 166877.44789f,   2338.47956f, 133600.85838f);
		answer[17] = Set( 40581.03150f, 111545.17473f, 109537.66611f,    743.79413f);
		answer[18] = Set(115569.04233f, 169498.72527f,  32919.91348f, 118011.72241f);
		answer[19] = Set( 37627.78642f,  70847.48018f, 167156.02860f,  80178.05651f);
	...
	SECTION("Subtraction", "[Sub], [operator-], [operator-=]") {
		//Setup Answers for this section
		answer[0]  = Set( -16652.25844f,   47507.25849f,  -69180.71412f,   86208.13120f);
		answer[1]  = Set( -21178.17990f,  -16583.07124f, -109221.06755f,   86088.53477f);
		answer[2]  = Set( -22750.85628f,  -39975.70642f, -206879.78347f,    6534.67596f);
		answer[3]  = Set( -42153.70788f, -134937.80991f, -207196.38203f,  -80297.65294f);
		answer[4]  = Set(-135211.77033f, -206853.15431f, -209218.26303f, -127066.18242f);
		answer[5]  = Set(-231377.96106f, -281389.77609f, -241821.57795f, -158245.57593f);
		answer[6]  = Set( -16652.25844f,   47507.25849f,  -69180.71412f,   86208.13120f);
		answer[7]  = Set( -73655.21085f,   23046.75909f,   -1705.28244f,   40063.79942f);
		answer[8]  = Set( -31529.18858f,   16635.48473f,  -29456.95925f,    -504.60127f);
		answer[9]  = Set( -76763.33913f,   20425.48171f,  -32286.71636f,   55652.93539f);
		answer[10] = Set( -34482.43366f,  -24062.20982f,   28161.40324f,   78929.66111f);
		answer[11] = Set( -88532.14099f,   -7825.01467f,   38018.47243f,  -46648.93305f);
		answer[12] = Set( -94593.51435f,   -51143.9866f,   65055.40100f,   48374.46530f);
		answer[13] = Set( -91640.26927f,  -10446.29205f,   7437.038510f,  -31059.79708f);
		answer[14] = Set( -91485.38607f,  -48522.70922f,  95636.834920f,   32785.32933f);
		answer[15] = Set( -16652.25844f,   47507.25849f,  -69180.71412f,   86208.13120f);
		answer[16] = Set( -73655.21085f,   23046.75909f,   -1705.28244f,   40063.79942f);
		answer[17] = Set( -31529.18858f,   16635.48473f,  -29456.95925f,    -504.60127f);
		answer[18] = Set( -76763.33913f,   20425.48171f,  -32286.71636f,   55652.93539f);
		answer[19] = Set( -34482.43366f,  -24062.20982f,   28161.40324f,   78929.66111f);
		...
		myVec = Sub(randVecA, randVecB);
		CHECK(myVec == answer[6]);

		//Static Sub: Vector vs FP
		myVec = Sub(randVecA, randFPB);
		CHECK(myVec == answer[7]);

		//Static Sub: FP vs Vector
		myVec = Sub(randFPA, randVecB);
		CHECK(myVec == answer[8]);

		//Static Sub: Vector vs m128
		myVec = Sub(randVecA, randM128B);
		CHECK(myVec == answer[9]);

		//Static Sub: m128 vs Vector
		myVec = Sub(randM128A, randVecB);
		CHECK(myVec == answer[10]);
	...
	SECTION("Scalar Multiply", "[Mul], [operator*], [operator*=]") {
		//Setup Answers for this section
		answer[0] = Set(142416.9307440f,  697021.8396166f,   2323.8334304f,  637349.2941260f);
		answer[1] = Set(405888.2526204f, 1986512.2429073f,   6622.9252766f, 1816445.4882591f);
		answer[2] = Set( 55298.1270600f,  270641.9949465f,    902.3058960f,  247472.1373650f);
		answer[3] = Set(264644.5076936f,  348318.5623000f, 510110.2750712f,    4581.6111180f);
		answer[4] = Set( 12898.8761610f,  182657.4397305f, 114115.0072755f,     340.8498255f);
		answer[5] = Set(683046.1783830f,  527858.6278960f,  14840.6065400f,  343281.0063832f);
		answer[6] = Set(  4482.1276830f,   66669.0102630f, 278327.3403720f,  226728.4976085f);
		answer[7] = Set(705859.8399582f,  547098.8038652f, 239308.3315128f,  228856.7483634f);
		answer[8] = Set( 55298.1270600f,  270641.9949465f,    902.3058960f,  247472.1373650f);
		answer[9] = Set(264644.5076936f,  348318.5623000f, 510110.2750712f,    4581.6111180f);
		...
		myVec = Mul(randVecA, randScalarB);
		CHECK(myVec == answer[2]);

		//Static Mul Test: Scalar & Vector
		myVec = Mul(randScalarA, randVecB);
		CHECK(myVec == answer[3]);
	...
	SECTION("Scalar Divide", "[Div], [operator/=], [operator/]") {
		//Setup Answers for this section
		answer[0] = Set( 2643.4402724f, 12937.6162792f,    43.1333188f, 11830.0175613f);
		answer[1] = Set(  927.5229026f,  4539.5144839f,    15.1344978f,  4150.8833548f);
		answer[2] = Set( 6808.0181052f, 33320.0363122f,   111.0872140f, 30467.4838245f);
		answer[3] = Set( 1588.0426175f, 22487.8349929f, 14049.2468175f,    41.9636596f);
		answer[4] = Set(  551.8162736f,  8207.9421684f, 34266.2161122f, 27913.6346701f);
		answer[5] = Set( 6808.0181052f, 33320.0363122f,   111.0872140f, 30467.4838245f);
		...
		//Static Mul Test: Vector & Scalar
		myVec = Div(randVecA, randScalarB);
		CHECK(myVec == answer[2]);
	...
	SECTION("Negate", "[Negate], [operator-]") {
		//Setup Answers for this section
		answer[0] = Set(-19402.85160f, -94962.10349f, -316.59856f, -86832.32890f);
		answer[1] = Set(-36055.11004f, -47454.84500f, -69497.31268f, -624.19770f);
		answer[2] = Set(-4525.92146f, -64090.32973f, -40040.35343f, -119.59643f);
		answer[3] = Set(-1572.67638, -23392.63518f, -97658.71592f, -79553.85881f);
		answer[4] = Set(1572.67638f, 23392.63518f, 97658.71592f, 79553.85881f);
...
TEST_CASE("Basic Normal Math Functions ", "[Min], [Max], [Average],[Length], [LengthSq]") {
	...
	SECTION("Minimum Value [Per Component]", "[Min]") {
		//Setup Answers for this section
		answer[0] = Set(19402.85160f, 47454.84500f,   316.59856f,   624.19770f);
		answer[1] = Set(19402.85160f, 47454.84500f,   316.59856f,   624.19770f);
		answer[2] = Set(19402.85160f, 71915.34440f,   316.59856f, 46768.52948f);
		answer[3] = Set( 4525.92146f, 47454.84500f, 40040.35343f,   119.59643f);
		answer[4] = Set(19402.85160f, 74536.62178f,   316.59856f, 31179.39351f);
		answer[5] = Set( 1572.67638f, 23392.63518f, 69497.31268f,   624.19770f);
		answer[6] = Set( 4525.92146f, 64090.32973f,  2021.88100f,   119.59643f);
		answer[7] = Set( 1572.67638f, 23392.63518f, 32603.31492f, 31179.39351f);
		answer[8] = Set( 4525.92146f, 64090.32973f, 32603.31492f,   119.59643f);
		answer[9] = Set( 1572.67638f, 23392.63518f,  2021.88100f, 46768.52948f);
	...
	SECTION("Maximum Value [Per Component]", "[Max]") {
		//Setup Answers for this section
		answer[0] = Set(36055.11004f, 94962.10349f, 69497.31268f, 86832.32890f);
		answer[1] = Set(36055.11004f, 94962.10349f, 69497.31268f, 86832.32890f);
		answer[2] = Set(93058.06245f, 94962.10349f,  2021.88100f, 86832.32890f);
		answer[3] = Set(36055.11004f, 64090.32973f, 69497.31268f,   624.19770f);
		answer[4] = Set(96166.19073f, 94962.10349f, 32603.31492f, 86832.32890f);
		answer[5] = Set(36055.11004f, 47454.84500f, 97658.71592f, 79553.85881f);
		answer[6] = Set(93058.06245f, 71915.34440f, 40040.35343f, 46768.52948f);
		answer[7] = Set(96166.19073f, 74536.62178f, 97658.71592f, 79553.85881f);
		answer[8] = Set(96166.19073f, 74536.62178f, 40040.35343f, 31179.39351f);
		answer[9] = Set(93058.06245f, 71915.34440f, 97658.71592f, 79553.85881f);
	...
	SECTION("Average Value [Per Component]", "[Avg]") {
		//Setup Answers for this section
		answer[0] = Set( 27728.98082f, 71208.474245f, 34906.955620f, 43728.263300f);
		answer[1] = Set( 27728.98082f, 71208.474245f, 34906.955620f, 43728.263300f);
		answer[2] = Set(56230.457025f, 83438.723945f,  1169.239780f, 66800.429190f);
		answer[3] = Set( 20290.51575f, 55772.587365f, 54768.833055f,   371.897065f);
		answer[4] = Set(57784.521165f, 84749.362635f, 16459.956740f, 59005.861205f);
		answer[5] = Set(18813.893210f, 35423.740090f, 83578.014300f, 40089.028255f);
		answer[6] = Set(48791.991955f, 68002.837065f, 21031.117215f, 23444.062955f);
		answer[7] = Set(48869.433555f, 48964.628480f, 65131.015420f, 55366.626160f);
		answer[8] = Set(50346.056095f, 69313.475755f, 36321.834175f, 15649.494970f);
		answer[9] = Set(47315.369415f, 47653.989790f, 49840.298460f, 63161.194145f);
...
TEST_CASE("Vector Math Functions", "[Dot], [Cross], [Normalize], [Homogenize], [AngleBetween], [Component], [Project], [Reflect]") {
	...
	SECTION("Cross Product Test", "[Cross], [Operator^]") {
		//Setup Answers for this section
		answer[0]  = Set( 0.742037332f, -0.150674138f, -0.282083134f, 0.0f);
		answer[1]  = Set( 0.159113879f, -0.409325970f,  0.637199657f, 0.0f);
		answer[2]  = Set(-0.546430804f, -0.144739851f,  0.043469805f, 0.0f);
		answer[3]  = Set(-0.043062441f,  0.010486891f, -0.506392274f, 0.0f);
		answer[4]  = Set( 0.309785247f, -0.399886951f, -0.034624698f, 0.0f);
		answer[5]  = Set(-0.083015257f, -0.106616827f,  0.488604282f, 0.0f);
		answer[6]  = Set( 0.742037332f, -0.150674138f, -0.282083134f, 0.0f);
		answer[7]  = Set( 0.014844052f, -0.000856801f, -0.652729601f, 0.0f);
		answer[8]  = Set( 0.368489821f,  0.162909051f, -0.302411187f, 0.0f);
		answer[9]  = Set( 0.251659389f, -0.049320726f, -0.629534898f, 0.0f);
		answer[10] = Set(-0.327208209f,  0.371052520f, -0.083610597f, 0.0f);
		answer[11] = Set(-0.308812887f,  0.417404713f, -0.633209766f, 0.0f);
		answer[12] = Set(-0.515099653f,  0.738302691f, -0.168553930f, 0.0f);
		answer[13] = Set(-0.093845581f,  0.388312880f, -0.610942729f, 0.0f);
		answer[14] = Set(-0.590497562f,  0.769012140f, -0.174695711f, 0.0f);
		answer[15] = Set( 0.742037332f, -0.150674138f, -0.282083134f, 0.0f);
		answer[16] = Set( 0.014844052f, -0.000856801f, -0.652729601f, 0.0f);
		answer[17] = Set( 0.368489821f,  0.162909051f, -0.302411187f, 0.0f);
		answer[18] = Set( 0.251659389f, -0.049320726f, -0.629534898f, 0.0f);
		answer[19] = Set(-0.327208209f,  0.371052520f, -0.083610597f, 0.0f);
	...
	SECTION("Normalize Test", "[Normalize]") {
		//Setup Answers for this section
		answer[0] = Set(0.149101802f, 0.729739170f, 0.002432911f, 0.667265670f);
		answer[1] = Set(0.393810990f, 0.518324295f, 0.759082568f, 0.006817782f);
		answer[2] = Set(0.059783384f, 0.846576074f, 0.528897344f, 0.001579762f);
		answer[3] = Set(0.012274654f, 0.182578253f, 0.762221000f, 0.620913569f);
	...
	SECTION("Homogenize Test", "[Homogenize]") {
		//Setup Answers for this section
		answer[0] = Set( 0.223451931f,  1.093626126f,   0.003646090f, 1.0f);
		answer[1] = Set(57.762324404f, 76.025344213f, 111.338623452f, 1.0f);
		answer[2] = Set( 1.989758144f,  1.537686670f,   0.043231656f, 1.0f);
		answer[3] = Set( 3.084286764f,  2.390573176f,   1.045668669f, 1.0f);
	...
	SECTION("Project Test", "[Project]") {
		//Setup Answers for this section
		answer[0] =  Set(22720.747894474f, 29904.487003928f, 43794.927237608f,   393.348919536f);
		answer[1] =  Set( 2979.507544385f, 42191.987342330f, 26359.391381165f,    78.732799191f);
		answer[2] =  Set(  342.223246538f,  5090.369295423f, 21251.087153047f, 17311.368176471f);
		answer[3] =  Set(22720.747894474f, 29904.487003928f, 43794.927237608f,   393.348919536f);
		answer[4] =  Set(73738.377916177f, 56985.076883461f,  1602.120454201f, 37058.965237247f);
		answer[5] =  Set(25753.932250504f, 33896.689310678f, 49641.481619864f,   445.860385917f);
		answer[6] =  Set(66600.241719226f, 51620.605847018f, 22579.543164151f, 21593.401263600f);
		answer[7] =  Set(34426.058224149f, 45310.727249911f, 66357.266143115f,   595.995029268f);
		answer[8] =  Set(29717.254507533f, 22965.517831192f, 645.66949578634f, 14935.108865467f);
		answer[9] =  Set(43171.054190119f, 33461.079341774f, 14636.323478182f, 13997.094785780f);
		answer[10] = Set(37244.234502319f, 28867.311884893f, 12626.948173945f, 12075.477199538f);
		answer[11] = Set(33375.627580646f, 25792.711440966f, 725.15530080633f, 16773.710749218f);
	...
	SECTION("Reflect Test", "[Reflect]") {
		//Setup Answers for this section
		answer[0]  = Set( 0.263859410f, -0.368988776f,  0.891193298f, 0.0f);
		answer[1]  = Set(-0.242965411f,  0.664862956f, -0.706346273f, 0.0f);
		answer[2]  = Set( 0.226186077f, -0.914445657f, -0.335602439f, 0.0f);
		answer[3]  = Set( 0.263859410f, -0.368988776f,  0.891193298f, 0.0f);
		answer[4]  = Set( 0.998304991f, -0.053558586f,  0.022773259f, 0.0f);
		answer[5]  = Set( 0.620613468f,  0.048944493f,  0.782587605f, 0.0f);
		answer[6]  = Set( 0.919689477f, -0.111758769f,  0.376405688f, 0.0f);
		answer[7]  = Set( 0.665667779f,  0.663828928f,  0.340906968f, 0.0f);
		answer[8]  = Set( 0.848413913f, -0.144721481f, -0.509165517f, 0.0f);
		answer[9]  = Set( 0.597331600f,  0.242201118f, -0.764547956f, 0.0f);
		answer[10] = Set( 0.983832565f, -0.037689804f, -0.175079873f, 0.0f);
		answer[11] = Set( 0.255711896f, -0.023200824f, -0.966474597f, 0.0f);
